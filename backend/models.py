...
class portfolio:
    def __init__(self, c):
        ...
        if self.cycle_type==1:
                ...
                self.aggressive={  "EF":25,
                                "EMB":60,
                                "HYB":10,
                                "IGCB":5,
                            }
                self.conservative={"EF":10,
                                "EMB":15,
                                "HYB":5,
                                "IGCB":70,
                                }
                ...
                self.aggressive={ "EF":30,
                            "EMB":60,
                            "HYB":10,
                            "IGCB":0,
                        }
                self.conservative={"EF":60,
                            "EMB":25,
                            "HYB":5,
                            "IGCB":10,
                        }
                ...
                self.aggressive={  "EF":20,
                            "EMB":70,
                            "HYB":5,
                            "IGCB":5,
                        },
                self.conservative={"EF":30,
                            "EMB":20,
                            "HYB":10,
                            "IGCB":40,
                        },
                ...
                self.aggressive={  "EF":0,
                            "EMB":20,
                            "HYB":0,
                            "IGCB":80,
                        },
                self.conservative={"EF":0,
                            "EMB":20,
                            "HYB":5,
                            "IGCB":75,
                        },